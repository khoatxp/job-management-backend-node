...
var dbUrl = "mongodb+srv://test1:test1@cluster0.9dygl.mongodb.net/ResumeParserApp?retryWrites=true&w=majority";
  ...
  socket.on('sendMessage', ({msg, receiver}) => {
      ...
      User.findOne({username: user.username}).then((result) => {
        ...
        if(!roomExist){
          ...
          MessageRoom.update({_id:roomid.messageRoomId}, {mostRecentDate: formattedMessage.dateSent, mostRecentTime: formattedMessage.timeSent});
